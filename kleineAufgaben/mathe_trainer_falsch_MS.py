...
# while not eingabe.isdigit() or (eingabe.isdigit and not (0<int(eingabe)<=100)) or type(eval(eingabe)!=float):
#     eingabe = input("Gib bitte die Echtezahl zwischen 1 und 100 ein!")

# #Wenn es float ist, machen wir int
# if type(eval(eingabe))==float:
#     eingabe=int(eingabe)
...
eingabe = input("Wie viele Übungen möchtest du machen?")
print(eval(eingabe))
print(type(eval(eingabe)))

#prüfen, ob es int, 0<eingabe>100 oder float ist:
while not eingabe.isdigit() and type(eval(eingabe))!=float and (eingabe.isdigit() and not 0<int(eingabe)<=100 ):
    print(not eingabe.isdigit())
    print(eingabe.isdigit() and not (0<int(eingabe)<=100))
    print(type(eval(eingabe))!=float)
    eingabe = input("Gib bitte die Wert ein!")
