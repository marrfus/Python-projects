...
while True:
 ...
 if geschlecht not in ["m","M","w","W"]:
   print("Du hast falsches Geschlecht eingedrückt. Sollte m oder w sein")
   continue
 print("-"*30)
...
#mit match case
 match geschlecht:
    case "m"|"M":
        match BMI:
            case n if n<20: print("Untergewicht")
            case n if n<25: print("Normalgewicht")
            case n if n<30: print("Übergewicht")
            case n if n<40: print("Adipositas")
            case _ : print("massive Adipositas")
    case "w"|"W":
        match BMI:
         case n if n<19: print("Untergewicht")
         case n if n<24: print("Normalgewicht")
         case n if n<30: print("Übergewicht")
         case n if n<40: print("Adipositas")
         case _ : print("massive Adipositas")
    case _: print("Fehler")
